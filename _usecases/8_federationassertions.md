...
<table>
  <tr>
    <td style="width:250px;border:0px;"><strong>1. Request access to federated service</strong> <br> <img src="../../img/usecases/8-1.png" width="250" alt="1. Request access to federated service"></td>
  ...
  <tr>
    <td style="width:250px;border:0px;"><strong>2. Redirect to Agency A for authentication</strong> <br> <img src="../../img/usecases/8-2.png" width="250" alt="2. Redirect to Agency A for authentication"></td>
  ...
  <tr>
    <td style="width:250px;border:0px;"><strong>3. Perform transparent transaction</strong> <br> <img src="../../img/usecases/8-3.png" width="250" alt="3. Perform transparent transaction"></td>
    <td style="border:0px;">Agency A passes identity attributes and transaction data to Agency B via a signed assertion.</td>
  </tr>
  <tr>
    <td style="width:250px;border:0px;"><strong>4. Agency B grants access</strong> <br> <img src="../../img/usecases/8-4.png" width="250" alt="4. Agency B grants access"></td>
